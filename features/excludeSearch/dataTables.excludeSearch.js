...
$.fn.dataTable.Api.register('exclude_search()', function (searchTerm) {
...
$.fn.dataTable.ext.search.push(function (context, search_data) {
	if (
...
$.fn.dataTable.ExcludeSearch = function (context) {
	...
	input_container.find('input').on('input', function () {
		table.exclude_search($(this).val()).draw();
	});
	this.node = function () {
		return input_container;
	};
};
$.fn.DataTable.ExcludeSearch = $.fn.dataTable.ExcludeSearch;
$.fn.dataTable.ext.feature.push({
	fnInit: function (settings) {
		return new $.fn.dataTable.ExcludeSearch(settings).node();
	},
	cFeature: 'X',
});
