export default {
    ...
    "buttons": {
        ...
        "pdf": "PDF",
        "print": "Εκτύπωση",
        "createState": "Δη΀�ιουργία κατάστασης",
    ...
    "editor": {
        ...
        "multi": {
            "info": "Τα επιλεγμένα αντικείμενα περιέχουν διαφορετικές τιμές για αυτό το πεδίο. Για να επεξεργαστείτε ή για να ορίσετε την ίδια τιμή για αυτό το πεδίο σε όλα τα αντικείμενα, κάντε κλικ ή π΀�τήστε εδώ, διαφορετικά θα διατηρήσουν τις αρχικές τους τιμές.",
