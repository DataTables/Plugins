...
=======
    ...
    "buttons": {
        "collection": "ټولګه <span class='ui-button-icon-primary ui-icon ui-icon-triangle-1-s'\/>",
        "colvis": "د کالم لید",
        "colvisRestore": "لید بیرته راګرځول",
        "copy": "کاپي",
        "copyKeys": "د میز ډیټا د خپل سیسټم کلپ بورډ څخه کاپي کولو لپاره فشار ورکړئ. د لغوه کولو لپاره، پدې پیغام کلیک وکړئ یا فرار فشار ورکړئ.",
        "copySuccess": {
            "1": "1 قطار کلپ بورډ ته کاپي شوی",
            "_": "کاپي شوي %d قطارونه کلپ بورډ ته"
        },
        "copyTitle": "کلپ بورډ ته کاپي کړئ",
        "csv": "سی اس وی",
        "excel": "اکسل",
        ...
        "stateRestore": "حالت %d",
        "savedStates": "حالت ذخیره کول",
        "renameState": "نوم بدلول",
        "removeState": "لیرې کول",
        "removeAllStates": "ټول حالات لیرې کول",
        "createState": "حالت جوړول"
    },
    "searchBuilder": {
        "add": "شرط اضافه کړئ",
    ...
    "editor": {
        ...
        "error": {
            "system": "د سیسټم یوه تېروتنه رامنځته شوې (<a target=\"\\\" rel=\"nofollow\" href=\"\\\">نور معلومات<\/a>)."
        },
        "multi": {
